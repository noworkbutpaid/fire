				...
				_createClass(Parallax, [{
					...
					value: function rotate(beta, gamma) {
						var x = (beta || event.beta || 0) / MAGIC_NUMBER,
							y = (gamma || event.gamma || 0) / MAGIC_NUMBER;
...
! function(t) {
	...
	Object.keys || (Object.keys = function() {
		...
		return function(s) {
			...
			if (e)
				for (r = 0; r < i; r++) t.call(s, a[r]) && o.push(a[r]);
			return o
		}
	}());
	var a = !1;
	...
	function o(t, e, a, i, s) {
		for (var r = {}, o = {}, h = {}, d = {}, u = {}, l = {}, c = null, f = 0; f < i.length; f++) {
			var m, p = i[f];
	...
	Array.prototype.indexOf || (Array.prototype.indexOf = function(t) {
		...
		for ((a = a < 0 ? Math.ceil(a) : Math.floor(a)) < 0 && (a += e); a < e; a++)
	...
	u.prototype.clearListeners = function() {
		...
		t(this.element).children("div.time_circles").remove(), void 0 === i && (i = !0), (i || null === this.listeners) && this.clearListeners(), this.container = t("<div>"), this.container.addClass("time_circles"), this.container.appendTo(this.element);
		...
		for (var l in this.data.text_elements)
			if (this.config.time[l].show) {
				...
				var f = t("<h4>");
				f.text(this.config.time[l].text), f.css("font-size", Math.round(this.config.text_size * this.data.attributes.item_size)), f.appendTo(c);
				var m = t("<span>");
				m.css("font-size", Math.round(this.config.number_size * this.data.attributes.item_size)), m.appendTo(c), this.data.text_elements[l] = m
		...
		var s, r;
		a && this.data.attributes.context.clearRect(0, 0, this.data.attributes.canvas[0].width, this.data.attributes.canvas[0].hright);
		...
		if (null !== this.data.attributes.context) {
			var o = n - s;
			if (Math.abs(o) > .5) 0 === s ? this.radialFade(t, a, i, 1) : this.radialFade(t, a, i, 0);
			else {
		...
		if (null !== this.data.attributes.context) {
			...
			a || this.data.attributes.context.clearRect(t - h, e - h, 2 * h, 2 * h), this.config.use_background && (this.data.attributes.context.beginPath(), this.data.attributes.context.arc(t, e, this.data.attributes.radius, 0, 2 * Math.PI, !1), this.data.attributes.context.lineWidth = this.data.attributes.line_width * this.config.bg_width, this.data.attributes.context.strokeStyle = this.config.circle_bg_color, this.data.attributes.context.stroke());
			var d = -.5 * Math.PI,
				u = 2 * Math.PI;
		...
		var r = function(t) {
			...
			return t = t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function(t, e, a, i) {
				return e + e + a + a + i + i
		...
		if (r) {
			...
			for (o = 0; s <= 1 && s >= 0; o++) ! function() {
				var i = 50 * o,
					n = "rgba(" + r.r + ", " + r.g + ", " + r.b + ", " + Math.round(10 * s) / 10 + ")";
		...
		if (void 0 === a && (a = t(this.element).attr("data-date")), "string" == typeof a) this.data.attributes.ref_date = function(t) {
			...
			void 0 === i && (i = t(this.element).attr("data-timer")), "string" == typeof i && (i = parseFloat(i)), "number" == typeof i ? (this.data.timer = i, this.data.attributes.ref_date = (new Date).getTime() + 1e3 * i) : this.data.attributes.ref_date = this.config.ref_date
		}
		...
		if (null === this.config && (this.default_options.ref_date = new Date, this.config = t.extend(!0, {}, this.default_options)), t.extend(!0, this.config, a), e = this.config.use_top_frame ? window.top : window, d(), this.data.total_duration = this.config.total_duration, "string" == typeof this.data.total_duration)
		...
		"function" == typeof t && (void 0 === a && (a = "visible"), this.listeners[a].push({
			func: t,
			scope: e
		}))
	...
	l.prototype.getInstance = function(e) {
		...
		if (void 0 === i && (i = r() + r() + "-" + r() + "-" + r() + "-" + r() + "-" + r() + r() + r(), t(e).attr("data-tc-id", i)), void 0 === h[i]) {
			var s = this.options,
				n = t(e).data("options");
			"string" == typeof n && (n = JSON.parse(n)), "object" == typeof n && (s = t.extend(!0, {}, this.options, n)), a = new u(e, s), h[i] = a
		} else a = h[i], void 0 !== this.options && a.setOptions(this.options);
		return a
